...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        #we have used speedtest for checking internet speed
    ...
    def tweet_at_provider(self):
        ...
        tweet = f"Hello Sir, why my internet  speed is very low i.e {self.down}down/{self.up}up when I pay for {PROMISED_DOWN}down/{PROMISED_UP}up?"
